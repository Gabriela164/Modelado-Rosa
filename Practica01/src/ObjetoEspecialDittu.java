/**
* Clase de los Objetos especiales que sirven como aumento de podere para Dittu.
* @author Juan Daniel San Martin Macias, Gabriela López Diego.
* @version 1.0 Septiembre 2022
*/
public class ObjetoEspecialDittu implements IObjetoEspecialDittu {
     ...
     */
	public ObjetoEspecialDittu(int ataque, int defensa, String nombre){
		this.ataque = ataque;
    ...
    public String toString(){
    	return "Dittu adquirió el objeto " + nombre + " con las siguientes características: " + "\n" + 
    				" Daño: " + ataque + "\n" +
    				" Defensa: " + defensa;
    }
}