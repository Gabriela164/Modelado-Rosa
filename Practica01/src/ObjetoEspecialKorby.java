/**
* Clase de los Objetos especiales que sirven como aumento de podere para Korby.
* @author Juan Daniel San Martin Macias, Gabriela López Diego.
* @version 1.0 Septiembre 2022
*/
public class ObjetoEspecialKorby implements IObjetoEspecialKorby {
     ...
     */
    public ObjetoEspecialKorby(int ataque, int defensa, String nombre){
        this.ataque = ataque;
    ...
    public String toString(){
        return "Korby adquirió el objeto " + nombre + " con las siguientes características: " + "\n" + 
                    " Daño: " + ataque + "\n" +
                    " Defensa: " + defensa;
    }
}