...
/**
* Clase de la prueba a presentar, donde siempre gana Dittu
* @author Juan Daniel San Martin Macias, Gabriela López Diego.
* @version 1.0 Septiembre 2022
*/
public class PruebaDittu extends Pruebas{
	
	/**
	 * Cosntructor vacio de la clase que genera las pruebas de Dittu
	 */
	public PruebaDittu(){
	}

	/**
	 * Método encargado de generar la batalla donde gana Dittu
	 */
	public void pelea(){
      ...
      //**********************************************Empieza el combate***********************************************
      //Pelea en la que ganará Dittu
      System.out.println("Aparecen los tres Peleadores");
      while(meganman.getVida() > 0 && korby.getVida() > 0){
         dittu.ataque();
      ...
      System.out.println("dittu obtuvo el poder del Guión y obtiene +10 de vida.");
      dittu.setVida(dittu.getVida() + 10);
      System.out.println("Ganó dittu con una vida sobrante de " + dittu.getVida());
      combate1.setGanadorDelCombate(dittu);
   }
}